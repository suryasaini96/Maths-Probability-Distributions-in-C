/*
	Name: Project on Probability Distributions
	Copyright: Surya Saini
	Author: Surya Saini
	Date: 23-04-17 20.30
	Description: Our maths project
...
enum openingPage{
	akshay,sparsh,manan,surya,mgf_data
}mainChoice;

enum momentChoice{
	directMGF,extractData
}dataChoice;
...
printf("5. Moment Generating Function for random variables fetched from data file \n\n");
printf("Choice: ");
fflush(stdin);
scanf("%d",&mainchoice);
switch(mainchoice)
{
	...
	case 2: /* Sparsh */
		{	system("cls");
		    ...
		    printf("Average of data points = %.2lf\n", mean);
		    printf("Variance = %.2lf\n", variance);
	...
	case 5: /* MGF */
		{
		    ...
		    system("COLOR FC");
		    int datachoice;
		    printf("\t\tMoment Generating Function for random variables fetched from data file \n\n");
